...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShopProductBundle:Product')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShopProductBundle:Product')->find($id);
        ...
        return $this->render('ShopProductBundle:Product:show.html.twig', array(
            'entity'      => $entity,
